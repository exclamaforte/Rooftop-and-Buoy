//need to change calculate geometry method.
define(["dojox/main", "dojo/_base/lang", "dojo/_base/array","dojo/_base/declare", "dojo/dom-style",
	...
	"dojox/charting/Element", "dojox/charting/SimpleTheme", "dojox/charting/Series", "dojox/charting/axis2d/common", "dojox/gfx/shape",
	"dojox/gfx", "dojo/has!dojo-bidi?dojox/charting/bidi/Chart", "dojox/lang/functional", "dojox/lang/functional/fold", "dojox/lang/functional/reversed"],
	   ...
	   var Chart = declare(has("dojo-bidi")? "dojox.charting.NonBidiChart" : "dojox.charting.Chart", null, {
		   ...
		   //this.offsets = this.margins; //////////changed line
		   ...
		   func.forIn(this.axes, function(axis){
		       ...
		       func.forIn(axis.getOffsets(), function(o, i){ offsets[i] = Math.max(o, offsets[i]); }); ///////////changed line
		   });
		   ...
		   if(this.title){
		       ...
		       offsets[this.titlePos == "top" ? "t" : "b"] += (tsize + this.titleGap); //////////changed line
		   }
		   // add margins
		   func.forIn(this.margins, function(o, i){ offsets[i] += o; }); //changed line
