define(["dojo/_base/lang", "dojo/_base/declare", "dojo/_base/connect", "dojo/_base/window", "dojo/sniff",
	"./ChartAction", "./_IndicatorElement", "dojox/lang/utils", "dojo/_base/event","dojo/_base/array", "dojox/lang/functional","dijit/registry",
	...
	return declare("CustomIndicator", ChartAction, {
		...
		onMouseMove: function(event){
			...
			funct.forEach(registry.byClass("graph"), function (item) {
			    var position = domGeom.position(item.chart.node, false);
			    event.pageX = event.clientX;
			    event.pageY = position.y - 10;
			    this._onMouseSingle(event);
			});
		    };
		},
