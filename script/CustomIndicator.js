define(["dojo/_base/lang", "dojo/_base/declare", "dojo/_base/connect", "dojo/_base/window", "dojo/sniff",
	"dojox/charting/action2d/ChartAction", "dojox/charting/action2d/_IndicatorElement", "dojox/lang/utils", 
	"dojo/_base/event","dojo/_base/array", "dojox/lang/functional","dijit/registry",
	"dojo/on", "dojo/dom-geometry"],
       function(lang, declare, hub, win, has, ChartAction, IndicatorElement, du, eventUtil, arr, funct, registry, on, domGeom){ 
	   ...
	   return declare("CustomIndicator", ChartAction, {
	       // summary:
	       ...
	       onMouseDown: function(event){
	           ...
	           if(this._isMouseDown || this.opt.mouseOver){
		           ...
		           if (registry.byId(indicator.chart.node.id).enabled === true) {
		               if (indicator.sizeUpdate === true || typeof indicator. sizeUpdate === "undefined") {
		                   indicator.positionHolder = domGeom.position(indicator.chart.node, false);
		                   indicator.sizeUpdate = false;
		               }
		               event.pageX = event.clientX;
		               event.pageY = indicator.positionHolder.y - 10;
		               indicator._onMouseSingle(event);
		           }
	               });
	           };
	       },
